...
export class SeederRoutes {
  ...
  public initializeRoutes(): void {
    ...
    const { seedRolesUsers, seedMesas, clearMesas } = this.controller;
    ...
    // Define una ruta DELETE en "/clear-mesas" que ejecuta el método clearMesas.
    this.router.delete('/clear-mesas', clearMesas.bind(this.controller));

    // Define una ruta POST en "/mesas" que ejecuta el método seedMesas.
    this.router.post('/mesas', seedMesas.bind(this.controller));
  }
}
