...
export class DatabaseConfig {
  ...
  public static readonly database: string =
    process.env.DB_NAME || 'basic-auth-management-ts-v2'; // Obtiene el nombre de la base de datos o usa "basic-auth-management-ts" por defecto.
}
